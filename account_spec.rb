...
describe Account do
  ...
  describe "#initialize" do
    ...
    #   it "creates a new account of the specified number" do
    #     expect(account.acct_number).to eq(valid_acct_number)
    #   end
    # end
    #cant do this as the private function doesnt show the number
  ...
  describe "#balance" do
    it "sums up all the transactions" do
      ...
      expect(account.balance).to be == 3
    end
  end
  ...
  describe "#withdraw!" do
    context "with invalid input" do
      it "requires an integer argument" do
        expect{account.withdraw!("hello")}.to raise_error
      end
    end
